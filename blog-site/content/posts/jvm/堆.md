...
![堆内存分配](/iblog/posts/images/essays/堆内存分配.png)

### 堆内存细分

![堆内存划分](/iblog/posts/images/essays/堆内存划分.png)
...
<div style="width: 45%;display: inline-block">
    <img src="/iblog/posts/images/essays/jvm1.8之前.png" alt="jvm1.8之前">
</div>
<div style="width: 45%;display: inline-block">
    <img src="/iblog/posts/images/essays/jvm1.8.png" alt="jvm1.8">
</div>
...
![设置堆大小](/iblog/posts/images/essays/设置堆大小.png)
...
![-XXPrintGCDetails](/iblog/posts/images/essays/-XXPrintGCDetails.png)

![PrintGCDetails查看堆内存](/iblog/posts/images/essays/PrintGCDetails查看堆内存.png)
...
![jstat](/iblog/posts/images/essays/jstat.png)
...
```
![OOM](/iblog/posts/images/essays/OOM.png)
...
![jvisual-OOM](/iblog/posts/images/essays/jvisual-OOM.png)
...
![年轻代与老年代](/iblog/posts/images/essays/年轻代与老年代.png)
...
![NewRatio](/iblog/posts/images/essays/NewRatio.png)
...
![SurvivorRatio](/iblog/posts/images/essays/SurvivorRatio.png)
...
![eden与survivor与tenured](/iblog/posts/images/essays/eden与survivor与tenured.png)
...
对象分配内存步骤：
![对象内存分配策略](/iblog/posts/images/essays/对象内存分配策略.png)
...
![代码演示对象分配过程](/iblog/posts/images/essays/代码演示对象分配过程.gif)
...
![TLAB](/iblog/posts/images/essays/TLAB.png)
...
![TLAB分配过程.png](/iblog/posts/images/essays/TLAB分配过程.png)
...
花费的时间为：881 ms
```
![栈上分配逃逸分析前](/iblog/posts/images/essays/栈上分配逃逸分析前.png)

逃逸分析之后
```
花费的时间为：5 ms
```
![栈上分配逃逸分析后](/iblog/posts/images/essays/栈上分配逃逸分析后.png)
