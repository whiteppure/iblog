...
![串行垃圾回收器](/iblog/posts/images/essays/串行垃圾回收器.png)

#### 并行垃圾回收器
在停止用户线程之后，多条GC线程并行进行垃圾回收。和串行回收相反，并行收集可以运用多个CPU同时执行垃圾回收，因此提升了应用的吞吐量。

![并行垃圾回收器](/iblog/posts/images/essays/并行垃圾回收器.png)
...
![并发垃圾回收器](/iblog/posts/images/essays/并发垃圾回收器.png)
...
#### 垃圾回收器与垃圾分代之间的关系
![收集器与垃圾分代之间的关系](/iblog/posts/images/essays/收集器与垃圾分代之间的关系.png)
...
#### 垃圾收集器的组合关系
![垃圾回收器组合关系](/iblog/posts/images/essays/垃圾回收器组合关系.png)
...
![jinfo命令查看GC](/iblog/posts/images/essays/jinfo命令查看GC.png)
