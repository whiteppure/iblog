...
![常见故障排查及程序配置-002](/iblog/posts/images/essays/常见故障排查及程序配置-002.png)

![常见故障排查及程序配置-001](/iblog/posts/images/essays/常见故障排查及程序配置-001.png)

![常见故障排查及程序配置-003](/iblog/posts/images/essays/常见故障排查及程序配置-003.png)
...
![常见故障排查及程序配置-006](/iblog/posts/images/essays/常见故障排查及程序配置-006.png)

![常见故障排查及程序配置-007](/iblog/posts/images/essays/常见故障排查及程序配置-007.png)

visual vm可以生成dump文件，生成的dump文件是临时的，如果想要保留该文件需要右键另存为即可：

![常见故障排查及程序配置-004](/iblog/posts/images/essays/常见故障排查及程序配置-004.png)

![常见故障排查及程序配置-005](/iblog/posts/images/essays/常见故障排查及程序配置-005.png)
...
![常见故障排查及程序配置-008](/iblog/posts/images/essays/常见故障排查及程序配置-008.png)

visual vm不但可以生成堆的dump文件，也可以对线程dump：

![常见故障排查及程序配置-009](/iblog/posts/images/essays/常见故障排查及程序配置-009.png)
...
![常见故障排查及程序配置-010](/iblog/posts/images/essays/常见故障排查及程序配置-010.png)

![常见故障排查及程序配置-011](/iblog/posts/images/essays/常见故障排查及程序配置-011.png)

![常见故障排查及程序配置-012](/iblog/posts/images/essays/常见故障排查及程序配置-012.png)

![常见故障排查及程序配置-013](/iblog/posts/images/essays/常见故障排查及程序配置-013.png)

![常见故障排查及程序配置-016](/iblog/posts/images/essays/常见故障排查及程序配置-016.png)
...
![常见故障排查及程序配置-015](/iblog/posts/images/essays/常见故障排查及程序配置-015.png)

- 浅堆：一个对象结构所占用的大小，即对象头+实例数据+对齐填充，不包括内部引用对象大小；
- 深堆：一个对象被 GC 回收后，可以真实释放的内存大小；
- 对象的实际大小：一个对象所能触及的所有对象的浅堆大小之和；

![常见故障排查及程序配置-017](/iblog/posts/images/essays/常见故障排查及程序配置-017.png)
...
![常见故障排查及程序配置-014](/iblog/posts/images/essays/常见故障排查及程序配置-014.png)

---
**支配树对象图**

![常见故障排查及程序配置-018](/iblog/posts/images/essays/常见故障排查及程序配置-018.png)
...
![常见故障排查及程序配置-019](/iblog/posts/images/essays/常见故障排查及程序配置-019.png)
