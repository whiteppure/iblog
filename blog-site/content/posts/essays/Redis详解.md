...
传统数据库遵循 ACID 规则。而 Nosql 一般为分布式,而分布式一般遵循 [CAP](https://whiteppure.github.io/myblog/posts/essays/java-transaction/#cap理论) 定理。

### Redis相关知识
Redis 默认16个数据库，类似数组下标从0开始，初始默认使用0号库。可使用命令 `select  <dbid>`来切换数据库。如: `select 8` 。

Redis是单线程+[多路IO复用技术](https://whiteppure.github.io/myblog/posts/rookie/rookie-io/#reactor-模型)
...
![Redis详解-001](/myblog/posts/images/essays/Redis详解-001.png)
...
![Redis详解-002](/myblog/posts/images/essays/Redis详解-002.png)
...
> ![Redis详解-003](/myblog/posts/images/essays/Redis详解-003.png)
>
...
>![Redis详解-004](/myblog/posts/images/essays/Redis详解-004.png)
>
>可以看出跳跃表比有序链表效率要高。
...
![Redis详解-009](/myblog/posts/images/essays/Redis详解-009.png)
...
![Redis详解-005](/myblog/posts/images/essays/Redis详解-005.png)

给这个频道发布消息后，消息就会发送给订阅的客户端：

![Redis详解-006](/myblog/posts/images/essays/Redis详解-006.png)
...
![Redis详解-008](/myblog/posts/images/essays/Redis详解-008.png)

3. 在另外一个客户端输入：`publish <channel> <message>`,channel为订阅的频道名称,message为推送的消息，返回的1是订阅者数量：
![Redis详解-007](/myblog/posts/images/essays/Redis详解-007.png)
...
![Redis详解-014](/myblog/posts/images/essays/Redis详解-014.png)
...
![Redis详解-015](/myblog/posts/images/essays/Redis详解-015.png)
...
![Redis详解-016](/myblog/posts/images/essays/Redis详解-016.png)
...
在Redis中可以使用[悲观锁、乐观锁](https://whiteppure.github.io/myblog/posts/rookie/rookie-multi-thread/#悲观锁与乐观锁)的思想来处理。

#### 悲观锁
![Redis详解-017](/myblog/posts/images/essays/Redis详解-017.png)
...
#### 乐观锁
![Redis详解-018](/myblog/posts/images/essays/Redis详解-018.png)
...
![Redis详解-019](/myblog/posts/images/essays/Redis详解-019.gif)
...
### 缓存穿透
![Redis详解-027](/myblog/posts/images/essays/Redis详解-027.png)
...
### 缓存击穿
![Redis详解-028](/myblog/posts/images/essays/Redis详解-028.png)
...
### 缓存雪崩
![Redis详解-029](/myblog/posts/images/essays/Redis详解-029.png)
...
## Redis主从复制
![Redis详解-022](/myblog/posts/images/essays/Redis详解-022.png)
...
### 主从复制过程
![Redis详解-023](/myblog/posts/images/essays/Redis详解-023.png)
...
## 一主二仆
![Redis详解-024](/myblog/posts/images/essays/Redis详解-024.png)
...
## 薪火相传
![Redis详解-025](/myblog/posts/images/essays/Redis详解-025.png)
...
## Redis哨兵模式
![Redis详解-026](/myblog/posts/images/essays/Redis详解-026.png)
...
![Redis详解-010](/myblog/posts/images/essays/Redis详解-010.png)
...
![Redis详解-011](/myblog/posts/images/essays/Redis详解-011.png)
...
![Redis详解-012](/myblog/posts/images/essays/Redis详解-012.png)
...
![Redis详解-013](/myblog/posts/images/essays/Redis详解-013.png)
...
![Redis详解-020](/myblog/posts/images/essays/Redis详解-020.png)
...
#### 执行过程
![Redis详解-021](/myblog/posts/images/essays/Redis详解-021.png)
