...
![数据结构与算法-010](/posts/annex/images/essays/数据结构与算法-010.png)
...
![数据结构与算法-011](/posts/annex/images/essays/数据结构与算法-011.png)
...
![数据结构与算法-014](/posts/annex/images/essays/数据结构与算法-014.gif)
...
![数据结构与算法-015](/posts/annex/images/essays/数据结构与算法-015.gif)
...
![数据结构与算法-016](/posts/annex/images/essays/数据结构与算法-016.gif)
...
![数据结构与算法-019](/posts/annex/images/essays/数据结构与算法-019.gif)
...
![数据结构与算法-018](/posts/annex/images/essays/数据结构与算法-018.gif)
...
![数据结构与算法-017](/posts/annex/images/essays/数据结构与算法-017.gif)
...
![数据结构与算法-020](/posts/annex/images/essays/数据结构与算法-020.gif)
...
![数据结构与算法-029](/posts/annex/images/essays/数据结构与算法-029.png)
...
- 常规算法匹配字符串：从主串的起始位置（或指定位置）开始与模式串的第一个字符比较，若相等则继续逐个比较后续字符；否则从主串的下一个字符再重新和模式串的字符比较。依次类推，直到模式串成功匹配，返回主串中第一次出现模式串字符的位置，或者模式串匹配不成功，这里约定返回-1。
  ![数据结构与算法-042](/posts/annex/images/essays/数据结构与算法-042.gif)

- KMP算法匹配字符串：主要是改进了暴力匹配中i回溯的操作，KMP算法中当一趟匹配过程中出现字符比较不等时，不直接回溯i，而是利用已经得到的“部分匹配”的结果将模式串向右移动（j-next[j-1]）的距离。
  ![数据结构与算法-043](/posts/annex/images/essays/数据结构与算法-043.gif)
...
![数据结构与算法-044](/posts/annex/images/essays/数据结构与算法-044.gif)
...
![数据结构与算法-045](/posts/annex/images/essays/数据结构与算法-045.gif)
...
![数据结构与算法-046](/posts/annex/images/essays/数据结构与算法-046.gif)
