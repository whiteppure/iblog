...
![线程与进程的关系](/iblog/posts/images/essays/线程与进程的关系.jpg)
...
并行与并发区别图解
![并行与并发区别](/iblog/posts/images/essays/并行与并发区别.png)
...
![线程状态转换](/iblog/posts/images/essays/线程转换图.jpg)
...
![阻塞队列](/iblog/posts/images/essays/阻塞队列结构.jpeg)
...
#### 线程池工作原理
![线程池工作原理](/iblog/posts/images/essays/线程池工作原理.png)
...
![悲观锁与乐观锁](/iblog/posts/images/essays/悲观锁与乐观锁.png)

在Java中悲观锁的实现有：`synchronized`、`Lock`实现类，乐观锁的实现有`CAS`。

### 自旋锁、适应性自旋锁
![自旋锁与非自旋锁](/iblog/posts/images/essays/自旋锁与非自旋锁.png)
...
也可以通过银行家算法来动态避免死锁问题。
![银行家算法](/iblog/posts/images/essays/银行家算法.png)
...
![Java内存模型](/iblog/posts/images/essays/Java内存模型.jpg)
...
```
![volitile字节码](/iblog/posts/images/essays/volitile字节码.png)
...
![CPU多级缓存](/iblog/posts/images/essays/CPU多级缓存.jpg)
...
![juc.locks](/iblog/posts/images/essays/juc.locks.png)
...
![JUC.locks包UML](/iblog/posts/images/essays/JUC.locks包UML.png)
...
![AQS](/iblog/posts/images/essays/AQS.png)
...
![AQS简单理解](/iblog/posts/images/essays/AQS简单理解.png)
...
加锁过程，如图所示：
![reentrantLock加锁](/iblog/posts/images/essays/reentrantLock加锁.png)
...
**ReentrantLock解锁**
![reentrantLock解锁](/iblog/posts/images/essays/reentrantLock解锁.png)
...
![CyclicBarrier](/iblog/posts/images/essays/CyclicBarrier.gif)
...
![synchronized原理](/iblog/posts/images/essays/synchronized原理.gif)
...
![jdk1.7ConcurrentHashMap](/iblog/posts/images/essays/jdk1.7ConcurrentHashMap.png)
...
![jdk1.8ConcurrentHashMap](/iblog/posts/images/essays/jdk1.8ConcurrentHashMap.png)
