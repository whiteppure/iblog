...
![获取阿里云docker地址](/iblog/posts/images/application/获取阿里云docker地址.jpg)

配置docker镜像地址
![docker配置](/iblog/posts/images/application/docker配置.jpg)
```
{
  "debug": true,
  "experimental": false,
...
![docker信息](/iblog/posts/images/application/docker信息.jpg)
...
![DockerFile](/iblog/posts/images/application/dockerFile.jpg)
```
# 基础镜像
...
```
使用 maven 打包
![docker打包](/iblog/posts/images/application/docker打包.jpg)
...
![hellodocker](/iblog/posts/images/application/hellodocker.jpg)
